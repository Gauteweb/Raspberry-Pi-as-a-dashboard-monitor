...
# If you want this script to run periodically to prevent the TV from turning off, just create a CRON job that runs this script every hour or something like that (se tv-cronjob.txt for an example).
# Turn TV on:
